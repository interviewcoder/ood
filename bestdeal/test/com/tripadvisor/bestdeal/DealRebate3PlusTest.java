...
public class DealRebate3PlusTest extends DealTest {
    ...
    public void testApplicableReservation() {
        ...
        Deal deal = getDealByHotel(HOTEL, DealType.REBATE_3PLUS, toDate("2015-06-21"), toDate("2015-06-30"));
    ...
    // 250 * 2 = 500;
    @Test
    public void testNotApplicableReservation_lessThan3Nights() {
        rsv = new Reservation(HOTEL, toDate("2015-06-22"), 2);
        Deal deal = getDealByHotel(HOTEL, DealType.REBATE_3PLUS, toDate("2015-06-21"), toDate("2015-06-30"));
        assertTrue(!deal.isApplicable(rsv));
        double actual = deal.getRealCost(rsv);
        double expected = 500;
